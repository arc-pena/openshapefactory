...
export const MATERIALS = {
  ...
  "M-TRAV":   { name: "Travertine", mark: "ST-01", description: "Roman travertine, honed, 30 mm cladding and paving", cut: { pattern: "P-STONE", pen: "heavy", lineColour: "#1b1f24", background: "#efe6d2" }, projection: { pen: "thin" }, shading: { colour: "#e4d8bd" } },
  "M-MARBLE": { name: "Tinos marble", mark: "ST-02", description: "Verde Tinos marble, polished, book-matched 25 mm", cut: { pattern: "P-STONE", pen: "heavy", lineColour: "#1b1f24", background: "#cfe0d4" }, projection: { pen: "thin" }, shading: { colour: "#5f8a72" } },
  "M-ONYX":   { name: "Onyx doré", mark: "ST-03", description: "Onyx doré, book-matched 25 mm", cut: { pattern: "P-STONE", pen: "heavy", lineColour: "#1b1f24", background: "#f3dfb5" }, projection: { pen: "thin" }, shading: { colour: "#d9a95a" } },
  "M-CHROME": { name: "Chrome-plated steel", mark: "SS-02", description: "Cruciform steel column, chrome-plated cover", cut: { pattern: null, pen: "heavy", lineColour: "#1b1f24", background: "#1b1f24" }, projection: { pen: "thin" }, shading: { colour: "#c5ccd4" } },
  "M-WATER":  { name: "Water", mark: "WA-01", description: "Reflecting pool, black-lined", cut: { pattern: null, pen: "thin", lineColour: "#2c5d7a", background: "#bcd9ea" }, projection: { pen: "hairline" }, shading: { colour: "#5b8fae" } },
...
export const TYPES = {
  ...
  // the pavilion: stone-faced walls on a concrete core, glass walls, cruciform chrome columns
  "T-TRAV300":   { family: "F-BASICWALL", name: "Travertine 300", mark: "SW1",
    layers: [ { function: "Finish 2", thickness: 30, material: "M-TRAV" }, { function: "Structure", thickness: 240, material: "M-CONC" }, { function: "Finish 1", thickness: 30, material: "M-TRAV" } ],
    coreStart: 1, coreEnd: 2, params: { Function: "Exterior" } },
  "T-MARBLE200": { family: "F-BASICWALL", name: "Tinos marble 200", mark: "SW2",
    layers: [ { function: "Finish 2", thickness: 25, material: "M-MARBLE" }, { function: "Structure", thickness: 150, material: "M-CONC" }, { function: "Finish 1", thickness: 25, material: "M-MARBLE" } ],
    coreStart: 1, coreEnd: 2, params: { Function: "Interior" } },
  "T-ONYX200":   { family: "F-BASICWALL", name: "Onyx doré 200", mark: "SW3",
    layers: [ { function: "Finish 2", thickness: 25, material: "M-ONYX" }, { function: "Structure", thickness: 150, material: "M-CONC" }, { function: "Finish 1", thickness: 25, material: "M-ONYX" } ],
    coreStart: 1, coreEnd: 2, params: { Function: "Interior" } },
  "T-GLASS30":   { family: "F-BASICWALL", name: "Glass wall 30 (steel glazing bars)", mark: "GW1",
    layers: [ { function: "Structure", thickness: 30, material: "M-GLASS" } ], coreStart: 0, coreEnd: 1, params: { Function: "Exterior" } },
  "T-DOOR1200G": { family: "F-SINGLEDOOR", name: "Glass door 1200×2600", mark: "D4", width: 1200, height: 2600, leafThickness: 30, frame: 30, glazed: true },
  "T-COLX180":   { family: "F-COLUMN", name: "Cruciform chrome 180", mark: "C3", width: 180, depth: 180, shape: "cross", arm: 40, material: "M-CHROME" },
  "T-PODIUM":    { family: "F-FLOOR", name: "Travertine paving 30 + bed 70 + concrete 300", mark: "FL4",
    layers: [ { function: "Finish 1", thickness: 30, material: "M-TRAV" }, { function: "Finish 2", thickness: 70, material: "M-SCREED" }, { function: "Structure", thickness: 300, material: "M-CONC" } ], coreStart: 2, coreEnd: 3 },
  "T-ROOF350":   { family: "F-FLOOR", name: "Flat roof plate 350, plastered soffit", mark: "RF1",
    layers: [ { function: "Finish 2", thickness: 30, material: "M-SCREED" }, { function: "Structure", thickness: 300, material: "M-CONC" }, { function: "Finish 1", thickness: 20, material: "M-PLAS" } ], coreStart: 1, coreEnd: 2 },
  "T-POOL":      { family: "F-FLOOR", name: "Reflecting pool: water 300 on concrete 250", mark: "PL1",
    layers: [ { function: "Finish 1", thickness: 300, material: "M-WATER" }, { function: "Structure", thickness: 250, material: "M-CONC" } ], coreStart: 1, coreEnd: 2 },
