...
export function buildSample() {
  ...
  add({ id: "V-P01", type: "PlanView", name: "First Floor Plan", args: { level: { ref: "L1" }, scale: 100, viewRange: { top: 2300, cut: 1200, bottom: 0 }, detailLevel: "Fine", style: { ref: "VS-CONSTRUCTION" }, filters: [], clip: { rect: null, visible: false, active: false }, overrides: {} } });
