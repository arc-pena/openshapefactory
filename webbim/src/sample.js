...
export function buildSample() {
  ...
  add({ id: "DIM2", type: "Dimension", args: { of: ["W4:core.exterior", "P1:centreline"], offset: 9300, view: { ref: "V-P00" }, locked: true } });
  add({ id: "DIM3", type: "Dimension", args: { of: ["P1:centreline", "W2:core.exterior"], offset: 9300, view: { ref: "V-P00" }, locked: false } });
  ed.apply({ op: "relate", store: "constraints", row: { id: "C1", kind: "distance", of: ["W4:core.exterior", "P1:centreline"], value: 6000, locked: true } }, { regenerate: false });
  // sheets
